...
BRAINROTS = {
    ...
    "Burguro And Fryuro": {"income": 150, "rarity": "Secret", "mutations": "All", "image": "https://images-ext-1.discordapp.net/external/qVX50l18q9QN8JHBQ5uJq5KvRz5KsHiZv6J7BjhK0cQ/https/www.mobynotifier.com/brainrots/burguro-and-fryuro?format=webp"},
    "Cooki and Milki": {"income": 155, "rarity": "Secret", "mutations": "All", "image": "https://steal-a-brainrot.wiki/wp-content/uploads/2025/11/Steal-a-Brainrot-Wiki-Cooki-and-Milki-Icon-300x300.png"},
    "Capitano Moby": {"income": 160, "rarity": "Secret", "mutations": "All", "image": "https://static.wikia.nocookie.net/stealabr/images/e/ef/Moby.png/revision/latest?cb=20251101185416"},
    "La Supreme Combinasion": {"income": 200, "rarity": "Secret", "mutations": "All", "image": "https://static.wikia.nocookie.net/stealabr/images/5/52/SupremeCombinasion.png/revision/latest?cb=20250825130920"},
    ...
    "Esok Sekolah": {"income": 30, "rarity": "Secret", "mutations": "All", "image": "https://images-ext-1.discordapp.net/external/X_HHUtR_dah9fT6uD5WMXHHLaCF0vjhP33OT-kXKAUk/https/www.mobynotifier.com/brainrots/esok-sekolah?format=webp"},
    "Spinny Hammy": {"income": 90, "rarity": "Secret", "mutations": "All", "image": "https://images-ext-1.discordapp.net/external/BoWX4KUkY2KLFTf2mUHpMH1tDNo2PRIq19ICSrGuRo8/https/www.mobynotifier.com/brainrots/spinny-hammy?format=webp"},
    "Cerberus": {"income": 26, "rarity": "Secret", "mutations": "All", "image": "https://images-ext-1.discordapp.net/external/NPtLqSPSBZtctUNyMptN6edlsdvC-9nhE7uJUppe5lo/https/www.mobynotifier.com/brainrots/cerberus?format=webp"},
    ...
    "Cigno Fulgoro": {"income": 20, "rarity": "Secret", "mutations": "All", "image": "https://static.wikia.nocookie.net/stealabr/images/8/87/Birdy.png"},
    "Money Money Puggy": {"income": 21, "rarity": "Secret", "mutations": "All", "image": "https://images-ext-1.discordapp.net/external/UdKYuXy_zc0xoCE5B_LB7Rd4gQxaE3YcyBh_Gu_IX6M/https/tr.rbxcdn.com/30DAY-Avatar-D21654E234F8633A1B3FC4936AFE8820-Png/420/420/Avatar/Png/noFilter?format=webp"},
    "Los Puggies": {"income": 30, "rarity": "Secret", "mutations": "All", "image": "https://images-ext-1.discordapp.net/external/xSRo3cOgaMz_3bOvc-uxwnvdHvBbEI91-5o129qDE1A/%3Fcb%3D20251109012744/https/static.wikia.nocookie.net/stealabr/images/c/c8/LosPuggies2.png/revision/latest?format=webp"},
    "Nuclearo Dinosauro": {"income": 15, "rarity": "Secret", "mutations": "All", "image": "https://images-ext-1.discordapp.net/external/wO_VfzWxp76PImVCn4peFiARwLyzlEbzI8SqaKEtXio/%3Fcb%3D20260328003025/https/static.wikia.nocookie.net/stealabr/images/b/b5/Nuclearo_Dinossauro.png/revision/latest/scale-to-width-down/1000?format=webp"},
    "Tang Tang Keletang": {"income": 20, "rarity": "Secret", "mutations": "All", "image": "https://images-ext-1.discordapp.net/external/4qWYUdmCoa0zhqxH2MKwV7Or5U9Xif8yw-AB_Gy5Lig/https/www.mobynotifier.com/brainrots/tang-tang-keletang?format=webp"},
...
def send_embed(brainrot_name, brainrot_data, mutation, trait, final_income, bot_count):
    ...
    embed = {
        ...
        "footer": {"text": f"Lazy AJ • {brainrot_data['rarity']} Brainrot"},
    }
    
    if brainrot_data.get("image") and brainrot_data["image"]:
        embed["thumbnail"] = {"url": brainrot_data["image"]}
